                    ...
                    <div class="group relative border-neutral-200 bg-zinc-50 dark:bg-zinc-900 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden border dark:border-zinc-700"
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex justify-end space-x-2 mt-4">
                                <flux:button variant="ghost" href="{{ route('admin.facilities.show', $facility) }}" wire:navigate
                                    class="text-sm">
                                ...
                                <flux:button variant="ghost" href="{{ route('admin.facilities.edit', $facility) }}" wire:navigate
