<div>
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="bg-white dark:bg-zinc-800 rounded-lg p-6 shadow-sm">
            <flux:heading size="lg" class="mb-4">Basic Facility Information</flux:heading>
            ...
            <!-- Image -->
            <flux:field class="mt-4">
                <flux:label for="image">Facility Image</flux:label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                ...
                <flux:field variant="inline">
                    <flux:label for="has_addons">This facility has add-ons (chairs, tables, etc.)</flux:label>
                    <flux:switch id="has_addons" wire:model.live="has_addons" />
                    <flux:error name="has_addons" />
                </flux:field>

                <!-- Has Sub-facilities -->
                <flux:field variant="inline">
                    <flux:label for="has_sub_facilities">This facility has sub-facilities (multiple courts, rooms, etc.)</flux:label>
                    <flux:switch id="has_sub_facilities" wire:model.live="has_sub_facilities" />
                    <flux:error name="has_sub_facilities" />
                </flux:field>
            </div>
        </div>
